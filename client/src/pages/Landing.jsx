...
//             <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-[var(--text-color)] mb-6">
//               Find Your Perfect{" "}
//               <span className="text-[var(--primary-500)]">Medical Career</span>
//             </h1>
//             <p className="text-[var(--text-secondary-color)] text-lg md:text-xl mb-8">
//               Connecting healthcare professionals with top medical institutions.
//               Discover thousands of opportunities in hospitals, clinics, and
//               private practices.
//             </p>
//             <div className="flex flex-col sm:flex-row justify-center md:justify-start gap-4">
//               <Link
...
//           <h2 className="text-3xl md:text-4xl font-bold text-[var(--text-color)] text-center mb-12">
//             Why Choose{" "}
//             <span className="text-[var(--primary-500)]">MedCareer Connect</span>
//           </h2>
//           <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
//             {features.map((feature, index) => (
//               <div
...
//             <span className="text-[var(--primary-500)]">Membership</span>
//           </h2>
//           {/* Rest of pricing section content */}
//           {/* ... */}
//         </div>
//       </section>
...
//             <span className="text-[var(--primary-500)]">Medical Jobs</span>
//           </h2>
//           {/* Rest of featured jobs section content */}
//           {/* ... */}
//         </div>
//       </section>
...
//             How It <span className="text-[var(--primary-500)]">Works</span>
//           </h2>
//           {/* Rest of how it works section content */}
//           {/* ... */}
//         </div>
//       </section>
...
//             <span className="text-[var(--primary-500)]">Say</span>
//           </h2>
//           {/* Rest of testimonials section content */}
//           {/* ... */}
//         </div>
//       </section>
...
// // Keep your existing features and jobCategories arrays
// const features = [
//   // ...
// ];
